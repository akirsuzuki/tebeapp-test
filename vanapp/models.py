...
class Pref(models.Model):
    pref = models.CharField("都道府県", max_length=6, blank=False)
...
class Review(models.Model):
    ...
    shop_kana = models.CharField('店舗名カナ', max_length=400, blank=False)
    shop_address = models.CharField('店舗住所', max_length=300, blank=False)
